...
# Initialize messages
    ...
    if x < 0.5:
        learn_instruction["content"] =  learn_instruction["content"] + " your response will include dry humour. if there any grammer mistakes correct those and teach user to correct those grammer mistakes"
    else:
        learn_instruction["content"] =  learn_instruction["content"] + " your response will include rather chalenging. if there any grammer mistakes correct those and teach user to correct those grammer mistakes"
